        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-2">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1.5 text-[9px] font-bold uppercase tracking-widest text-[#2D1810]/80">
              ...
              <li><a href="https://www.instagram.com/saundaryashringarpvtltd?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:text-brand-pink transition-colors group"><FiInstagram className="group-hover:scale-110 transition-transform" /> Instagram</a></li>
              <li><a href="https://api.whatsapp.com/send?phone=919896472169" target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:text-brand-pink transition-colors group">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1.5 text-[9px] font-bold uppercase tracking-widest text-[#2D1810]/80">
              ...
              <li><a href="https://api.whatsapp.com/send?phone=919896472169" target="_blank" rel="noreferrer" className="hover:text-brand-pink transition-colors">Help Support</a></li>
            </ul>
          </div>
