...
const AdminBlogs = () => {
    ...
    return (
        <div className="pt-8 md:pt-12 pb-12 px-4 md:px-8 space-y-8 max-w-7xl mx-auto">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-brand-dark/95 backdrop-blur-sm z-[2000] overflow-y-auto flex justify-center pt-20 pb-10 px-4">
                    <div className="bg-white w-full max-w-4xl rounded-none shadow-2xl relative h-fit mb-10">
                        <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-white z-10">
                            ...
                            <button onClick={() => setIsModalOpen(false)} className="text-gray-400 hover:text-brand-dark p-3 leading-none text-xl transition-colors">✕</button>
                        </div>
